...
<aside class="left-sidebar">
    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
                        ...
                        <a class="sidebar-link justify-content-between"
                           href="{{ route('admin.about.edit') }}">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="hide-menu">Hakkımızda İçeriği</span>
                            </div>
            ...
            <li class="sidebar-item">
                        <a class="sidebar-link justify-content-between"
                           href="{{ route('admin.service-content.edit') }}">
                            <div class="d-flex align-items-center gap-3">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-circle"></i>
                                </div>
                                <span class="hide-menu">Hizmetler İçeriği</span>
                            </div>
            ...
            <li class="sidebar-item">
                        <a class="sidebar-link justify-content-between"
                           href="{{ route('admin.contact-content.edit') }}">
                            <div class="d-flex align-items-center gap-3">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-circle"></i>
                                </div>
                                <span class="hide-menu">İletişim İçeriği</span>
                            </div>
            ...
            <li class="sidebar-item">
                        <a class="sidebar-link justify-content-between"
                           href="{{ route('admin.home-content.edit') }}">
                            <div class="d-flex align-items-center gap-3">
                                <div class="round-16 d-flex align-items-center justify-content-center">
                                    <i class="ti ti-home"></i>
                                </div>
                                <span class="hide-menu">Ana Sayfa İçeriği</span>
                            </div>
