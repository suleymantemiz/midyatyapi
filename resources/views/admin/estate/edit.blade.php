                    ...
                    <form action="{{ route('estate.update', $estate->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   value="{{ old('name', $estate->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="features"
                                      name="features">{{ old('features', $estate->features) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                <option value="Daire" {{ old('type', $estate->type) == 'Daire' ? 'selected' : '' }}>
                                    Daire
                                </option>
                                <option
                                    value="Müstakil" {{ old('type', $estate->type) == 'Müstakil' ? 'selected' : '' }}>
                                    Müstakil
                                </option>
                                <option value="Arsa" {{ old('type', $estate->type) == 'Arsa' ? 'selected' : '' }}>Arsa
                                </option>
                                <option value="Dükkan" {{ old('type', $estate->type) == 'Dükkan' ? 'selected' : '' }}>
                                    Dükkan
                                </option>
                                <option value="Ofis" {{ old('type', $estate->type) == 'Ofis' ? 'selected' : '' }}>Ofis
                                </option>
                                <option value="Villa" {{ old('type', $estate->type) == 'Villa' ? 'selected' : '' }}>
                                    Villa
                                </option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="status" name="status" required>
                                <option
                                    value="Satılık" {{ old('status', $estate->status) == 'Satılık' ? 'selected' : '' }}>
                                    Satılık
                                </option>
                                <option
                                    value="Kiralık" {{ old('status', $estate->status) == 'Kiralık' ? 'selected' : '' }}>
                                    Kiralık
                                </option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="parcel_number" name="parcel_number"
                                   value="{{ old('parcel_number', $estate->parcel_number) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3"
                                      placeholder="Tam adresi giriniz">{{ old('address', $estate->address) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.000001" class="form-control" id="latitude"
                                           name="latitude" placeholder="Örn: 37.4192"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.000001" class="form-control" id="longitude"
                                           name="longitude" placeholder="Örn: 41.3391"
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="gross_m2"
                                           value="{{ old('gross_m2', $estate->gross_m2) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="net_m2" class="form-label">Net m²</label>
                                    <input type="number" class="form-control" name="net_m2"
                                           value="{{ old('net_m2', $estate->net_m2) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="number_of_rooms" class="form-label">Oda Sayısı</label>
                                    <input type="number" class="form-control" name="number_of_rooms"
                                           value="{{ old('number_of_rooms', $estate->number_of_rooms) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="building_age" class="form-label">Bina Yaşı</label>
                                    <input type="number" class="form-control" name="building_age"
                                           value="{{ old('building_age', $estate->building_age) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="number_of_floors" class="form-label">Kat Sayısı</label>
                                    <input type="number" class="form-control" name="number_of_floors"
                                           value="{{ old('number_of_floors', $estate->number_of_floors) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="heating" class="form-label">Isıtma</label>
                                    <select class="form-control" name="heating">
                                        <option value="" {{ old('heating', $estate->heating) == '' ? 'selected' : '' }}>
                                            Seçiniz
                                        </option>
                                        <option
                                            value="Doğalgaz" {{ old('heating', $estate->heating) == 'Doğalgaz' ? 'selected' : '' }}>
                                            Doğalgaz
                                        </option>
                                        <option
                                            value="Soba" {{ old('heating', $estate->heating) == 'Soba' ? 'selected' : '' }}>
                                            Soba
                                        </option>
                                        <option
                                            value="Klima" {{ old('heating', $estate->heating) == 'Klima' ? 'selected' : '' }}>
                                            Klima
                                        </option>
                                        <option
                                            value="Merkezi" {{ old('heating', $estate->heating) == 'Merkezi' ? 'selected' : '' }}>
                                            Merkezi
                                        </option>
                                        <option
                                            value="Yok" {{ old('heating', $estate->heating) == 'Yok' ? 'selected' : '' }}>
                                            Yok
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="number_of_bathrooms"
                                           value="{{ old('number_of_bathrooms', $estate->number_of_bathrooms) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="kitchen" class="form-label">Mutfak</label>
                                    <input type="text" class="form-control" name="kitchen"
                                           value="{{ old('kitchen', $estate->kitchen) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="parking" class="form-label">Otopark</label>
                                    <select name="parking" class="form-control">
                                        <option
                                            value="Yok" {{ old('parking', $estate->parking) == 'Yok' ? 'selected' : '' }}>
                                            Yok
                                        </option>
                                        <option
                                            value="Kapalı Otopark" {{ old('parking', $estate->parking) == 'Kapalı Otopark' ? 'selected' : '' }}>
                                            Kapalı Otopark
                                        </option>
                                        <option
                                            value="Açık Otopark" {{ old('parking', $estate->parking) == 'Açık Otopark' ? 'selected' : '' }}>
                                            Açık Otopark
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="furnished" class="form-control">
                                        <option
                                            value="Evet" {{ old('furnished', $estate->furnished) == 'Evet' ? 'selected' : '' }}>
                                            Evet
                                        </option>
                                        <option
                                            value="Hayır" {{ old('furnished', $estate->furnished) == 'Hayır' ? 'selected' : '' }}>
                                            Hayır
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" name="usage_status">
                                        <option
                                            value="" {{ old('usage_status', $estate->usage_status) == '' ? 'selected' : '' }}>
                                            Seçiniz
                                        </option>
                                        <option
                                            value="Boş" {{ old('usage_status', $estate->usage_status) == 'Boş' ? 'selected' : '' }}>
                                            Boş
                                        </option>
                                        <option
                                            value="Kiracı" {{ old('usage_status', $estate->usage_status) == 'Kiracı' ? 'selected' : '' }}>
                                            Kiracı
                                        </option>
                                        <option
                                            value="Ev Sahibi" {{ old('usage_status', $estate->usage_status) == 'Ev Sahibi' ? 'selected' : '' }}>
                                            Ev Sahibi
                                        </option>
                                        <option
                                            value="İnşaat Halinde" {{ old('usage_status', $estate->usage_status) == 'İnşaat Halinde' ? 'selected' : '' }}>
                                            İnşaat Halinde
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" name="site_content">
                                        <option
                                            value="" {{ old('site_content', $estate->site_content) == '' ? 'selected' : '' }}>
                                            Seçiniz
                                        </option>
                                        <option
                                            value="Evet" {{ old('site_content', $estate->site_content) == 'Evet' ? 'selected' : '' }}>
                                            Evet
                                        </option>
                                        <option
                                            value="Hayır" {{ old('site_content', $estate->site_content) == 'Hayır' ? 'selected' : '' }}>
                                            Hayır
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="site_name"
                                           value="{{ old('site_name', $estate->site_name) }}">
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="help_tl" class="form-label">Aidat (₺)</label>
                                    <input type="number" step="0.01" class="form-control" name="help_tl"
                                           value="{{ old('help_tl', $estate->help_tl) }}">
                                </div>
                            </div>
                        </div>
                        <!-- Arsa Alanları -->
                        <div id="land-fields" style="display: none;">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" name="open_area_m2"
                                       value="{{ old('open_area_m2', $estate->open_area_m2) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="available_for_credit" class="form-control">
                                    <option
                                        value="Evet" {{ old('available_for_credit', $estate->available_for_credit) == 'Evet' ? 'selected' : '' }}>
                                        Evet
                                    </option>
                                    <option
                                        value="Hayır" {{ old('available_for_credit', $estate->available_for_credit) == 'Hayır' ? 'selected' : '' }}>
                                        Hayır
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" name="title_deed_status">
                                    <option
                                        value="" {{ old('title_deed_status', $estate->title_deed_status) == '' ? 'selected' : '' }}>
                                        Seçiniz
                                    </option>
                                    <option
                                        value="Kat Mülkiyetli" {{ old('title_deed_status', $estate->title_deed_status) == 'Kat Mülkiyetli' ? 'selected' : '' }}>
                                        Kat Mülkiyetli
                                    </option>
                                    <option
                                        value="Kat İrtifaklı" {{ old('title_deed_status', $estate->title_deed_status) == 'Kat İrtifaklı' ? 'selected' : '' }}>
                                        Kat İrtifaklı
                                    </option>
                                    <option
                                        value="Arsa Tapulu" {{ old('title_deed_status', $estate->title_deed_status) == 'Arsa Tapulu' ? 'selected' : '' }}>
                                        Arsa Tapulu
                                    </option>
                                    <option
                                        value="Hisseli Tapulu" {{ old('title_deed_status', $estate->title_deed_status) == 'Hisseli Tapulu' ? 'selected' : '' }}>
                                        Hisseli Tapulu
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" name="from_person">
                                    <option
                                        value="" {{ old('from_person', $estate->from_person) == '' ? 'selected' : '' }}>
                                        Seçiniz
                                    </option>
                                    <option
                                        value="Sahibinden" {{ old('from_person', $estate->from_person) == 'Sahibinden' ? 'selected' : '' }}>
                                        Sahibinden
                                    </option>
                                    <option
                                        value="Emlakçıdan" {{ old('from_person', $estate->from_person) == 'Emlakçıdan' ? 'selected' : '' }}>
                                        Emlakçıdan
                                    </option>
                                    <option
                                        value="Bankadan" {{ old('from_person', $estate->from_person) == 'Bankadan' ? 'selected' : '' }}>
                                        Bankadan
                                    </option>
                                    <option
                                        value="Müteahhitten" {{ old('from_person', $estate->from_person) == 'Müteahhitten' ? 'selected' : '' }}>
                                        Müteahhitten
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="exchange" class="form-control">
                                    <option
                                        value="Var" {{ old('exchange', $estate->exchange) == 'Var' ? 'selected' : '' }}>
                                        Var
                                    </option>
                                    <option
                                        value="Yok" {{ old('exchange', $estate->exchange) == 'Yok' ? 'selected' : '' }}>
                                        Yok
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="is_featured" class="form-control">
                                    <option
                                        value="0" {{ old('is_featured', $estate->is_featured) == 0 ? 'selected' : '' }}>
                                        Hayır
                                    </option>
                                    <option
                                        value="1" {{ old('is_featured', $estate->is_featured) == 1 ? 'selected' : '' }}>
                                        Evet
                                    </option>
                                </select>
